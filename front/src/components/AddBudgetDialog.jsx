...
export function AddBudgetDialog({ token, onBudgetAdded }) {
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4 py-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <Select onValueChange={setCategory} value={category}>
                            ...
                            <SelectContent>
                                {(categories || []).length === 0 ? (
                                    <p className="p-2 text-xs text-muted-foreground text-center">Loading categories...</p>
                                ) : (
                                    categories.map((cat) => {
                                        const catId = cat.id_category !== undefined ? cat.id_category : cat.id;
                                        return (
